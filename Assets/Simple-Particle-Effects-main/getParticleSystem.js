...
function getParticleSystem(params) {
  ...
  colorSpline.addPoint(0.0, new THREE.Color(0xFF1121));
  colorSpline.addPoint(1.0, new THREE.Color(0xff1010));
    ...
    for (let i = 0; i < n; i += 1) {
      ...
      _particles.push({
        position: new THREE.Vector3(
          ...
          (Math.random() * 2 - 1) * radius,
          (Math.random() * 2 - 1) * radius).add(emitter.position).add(new THREE.Vector3(0, 2, 0)),
